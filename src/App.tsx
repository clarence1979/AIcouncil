    ...
    <div className="min-h-screen flex flex-col relative bg-gray-950">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <svg className="absolute inset-0 w-full h-full" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice">
          ...
          <g transform="translate(12%, 15%) scale(0.55)" opacity="0.22" filter="url(#glow-green)">
            <path
          ...
          <g transform="translate(42%, 30%) scale(0.55)" opacity="0.20" filter="url(#glow-orange)">
            <path
          ...
          <g transform="translate(72%, 10%) scale(0.55)" opacity="0.20" filter="url(#glow-blue)">
            <path
          ...
          <circle cx="20%" cy="70%" r="300" fill="rgba(16,163,127,0.04)" />
          <circle cx="80%" cy="30%" r="250" fill="rgba(66,133,244,0.04)" />
          <circle cx="50%" cy="90%" r="200" fill="rgba(230,126,34,0.04)" />
        </svg>
      </div>
